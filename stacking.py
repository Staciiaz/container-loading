...
class Stacking:
    ...
    def initialize():
        Stacking.register({
            'HU_2': [np.full((1, 1), 'HU'), np.full((1, 1), 'HU')],
            'U_3': [np.full((1, 1), 'U'), np.full((1, 1), 'U'), np.full((1, 1), 'U')],
            'MU_4': [np.full((1, 1), 'MU'), np.full((1, 1), 'MU'), np.full((1, 1), 'MU'), np.full((1, 1), 'MU')],
            '2HUL_2': [np.full((1, 1), '2HUL'), np.full((1, 1), '2HUL')],
            '2UL_3': [np.full((1, 1), '2UL'), np.full((1, 1), '2UL'), np.full((1, 1), '2UL')],
            'WUL03_3': [np.full((1, 1), 'WUL03'), np.full((1, 1), 'WUL03'), np.full((1, 1), 'WUL03')],
            'Mix_MU+HU': [np.full((1, 1), 'MU'), np.full((1, 1), 'MU'), np.full((1, 1), 'HU')],
            'Mix_U+etc': [np.full((2, 1), 'U'), np.full((1, 1), 'etc')],
            'Mix_MU+etc': [np.full((2, 1), 'MU'), np.full((1, 1), 'etc')],
            'Mix_etc+WUL01': [np.full((1, 2), 'etc'), np.full((1, 1), 'WUL01')],
            'Mix_HU+2HUL': [np.full((3, 1), 'HU'), np.full((1, 1), '2HUL')],
            'Mix_U+2UL': [np.full((3, 1), 'U'), np.full((3, 1), 'U'), np.full((1, 1), '2UL')],
            'Mix_WUL01+WUL03': [np.full((1, 1), 'WUL01'), np.full((1, 1), 'WUL03'), np.full((1, 1), 'WUL03')],
            'Mix_MU+2HUL': [np.full((3, 1), 'MU'), np.full((3, 1), 'MU'), np.full((1, 1), '2HUL')],
        })
